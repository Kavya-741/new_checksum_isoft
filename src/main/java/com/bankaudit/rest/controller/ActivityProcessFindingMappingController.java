...
public class ActivityProcessFindingMappingController {
	...
	ServiceStatus createActivityProcessFindingMapping(@RequestBody ActivityProcessFindingMapping activityProcessFindingMapping){
	...
	DataTableResponse getActivityProcessFindingMappings(
		...
		if(!BankAuditUtil.isEmptyString(drawStr)
			...
			try {
				...
				dataTableResponse = activityProcessFindingMappingService.getActivityProcessFindingMappings(legalEntityCode,search,orderColumn,orderDirection,page,size);
	...
	ServiceStatus isMaintAuditFinding(
		...
		if(legalEntityCode!=null 
			...
			try {
			    Boolean activityProcessFindingMapping=activityProcessFindingMappingService.isActivityProcessFindingMapping(Integer.parseInt(legalEntityCode),auditTypeCode,
			    		auditGroupCode,auditSubGroupCode,activityCode,processCode,findingCode,mappingId,riskBelongsTo); // riskBelongsTo added to handle one more parameter in RCSA Setup
